...
class TransactionRepositoryImpl(
    ...
    override suspend fun syncTransactions(accountId: String?): Result<Unit> = withContext(dispatchers.io) {
        try {
    ...
    override suspend fun recordTransaction(transaction: Transaction): Result<Transaction> = withContext(dispatchers.io) {
        try {
